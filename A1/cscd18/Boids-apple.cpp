...
//    Min and max values ------------|--|
      ...
      // GLUI_Slider *slider - glui->add_slider("slider of alix", 
      //                      GLUI_SLIDER_FLOAT, 
      //                      0, 1, int ticks=10,
      //                      shapeness );
 ...
 */
 ...
 glColor4f(1,0,0,1);	// This specifies colour as R,G,B,alpha.
 ...
 glPushMatrix();	// Save current transformation matrix
  ...
  glTranslatef(Boid_Location[i][0],Boid_Location[i][1],Boid_Location[i][2]);
    ...
    glBegin (GL_LINE_LOOP);
      ...
      glVertex3f(0.8,5.1,0.0);
      glVertex3f(0.0,4.0,0.0);
      glVertex3f(-0.5,3.0,0.0);
      glVertex3f(-1.0,2.5,0.0);
      glVertex3f(-1.5,4.5,0.0);
      glVertex3f(-2.8,4.9,0.0);
      glVertex3f(-2.6,3.7,0.0);
      glVertex3f(-1.6,2.8,0.0);
      glVertex3f(-1.0,2.7,0.0);
      glVertex3f(-0.5,3.0,0.0);
      glVertex3f(-1.5,2.0,0.0);
      glVertex3f(-2.5,1.2,0.0);
      glVertex3f(-2.6,-1.0, 0.0);
      glVertex3f(-1.8,-2.1, 0.0);
      glVertex3f(-0.3,-2.4, 0.0);
      glVertex3f(1.1,-2.2, 0.0);
      glVertex3f(2.1,-1.9, 0.0);
      glVertex3f(3.1,-0.1, 0.0);
      glVertex3f(2.1,2.1, 0.0);
      glVertex3f(2.3,2.5, 0.0);
      glVertex3f(-0.5,3.0,0.0);
